...
Item {
    ...
    Column {
        ...
        Column {
            width: parent.width
            spacing: Units.smallSpacing
            visible: !Extensions.themesModel.get(selectedName).valid

            Label {
                width: parent.width
                wrapMode: Text.WordWrap
                text: "The selected theme %1 could not be found. ".arg('"' + selectedName + '"')
            ...
            Label {
                width: parent.width
                wrapMode: Text.WordWrap
                text: "Either this theme has been removed or there was a problem loading it."
                color: Material.color(Material.Red)
            }
            ...
            Label {
                width: parent.width
                wrapMode: Text.WordWrap
                text: "Select another theme below."
                color: Material.color(Material.Red)
            }
        }
