...
#ifndef SECONDARYTHEMETIMER_H
#define SECONDARYTHEMETIMER_H

#include <QObject>
#include <QTime>
#include <QTimer>

class SecondaryThemeTimer : public QObject
{
    Q_OBJECT
...
public:
    explicit SecondaryThemeTimer(QObject *parent = nullptr);
